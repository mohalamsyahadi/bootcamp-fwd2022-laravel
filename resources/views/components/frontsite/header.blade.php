      ...
      <div class="flex flex-auto justify-between">
        ...
        <div class="hidden lg:ml-6 lg:flex lg:space-x-12">
         ...
         -->
          <a
            href="{{ route('index') }}"
          class="text-[#1E2B4F] relative after:absolute after:content-[''] after:border-b-2 after:border-[#0D63F5] after:w-8/12 after:-translate-x-1/2 after:bottom-3 after:left-1/2 {{ request()->is('home') ? 'font-semibold' : 'font-semibold' }} inline-flex items-center px-1 text-lg"
          >
            Home
          </a>
          <a
